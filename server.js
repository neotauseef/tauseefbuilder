...
app.get("/contact/thanks", (req, res) => {
  ...
  res.render("thanks.njk", {
    page_id: "thanks",
    meta: {
      title: "Enquiry received — Australia Construction Consultants & Associates",
...
app.use((req, res) => {
  res.status(404).render("404.njk", {
    page_id: "notfound",
    meta: { title: "Not found — Australia Construction Consultants & Associates", description: "The page you were looking for cannot be found." },
  });
});

app.listen(port, () => {
  console.log(`Australia Construction Consultants & Associates → http://localhost:${port}`);
});
